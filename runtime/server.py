...
class EngineManager:
    ...
    def get(
        ...
        if not 1 <= qwen_mtp_depth <= 7:
            raise RequestValidationError(
                "VMODEL_QWEN_MTP_DEPTH must be in [1, 7]")
        ...
        if qwen35_head_pre_admit_request == "1" and qwen35_suspend_lm_head_request != "1":
            raise RequestValidationError("phase-head pre-admission requires the phase-scoped head")
        try:
        ...
        glm53_fp8_direct_qmv_request = os.environ.get(
            "VMODEL_GLM53_FP8_DIRECT_QMV", "0").strip()
        ...
        try:
            ...
            glm53_expert_batch_prefetch_workers = int(os.environ.get(
        ...
        if not 1 <= glm53_expert_batch_prefetch_workers <= 2:
            raise RequestValidationError(
                "VMODEL_GLM53_EXPERT_BATCH_PREFETCH_WORKERS must be in [1, 2]")
        ...
        if (glm53_fp8_direct_qmv_request == "1"
                and mtype not in ("glm_moe_dsa", "glm5_next")):
            raise RequestValidationError(
                "VMODEL_GLM53_FP8_DIRECT_QMV requires a GLM-5.3 "
                "fine-grained-FP8 checkpoint")
        ...
        with self._lock:
            ...
            if mtype == "jet_nemotron":
                ...
                if qwen4_request_identity[37] not in ("0", "1"):
                    raise RequestValidationError(
...
def _vision_protocol_timing(result: dict) -> dict:
    ...
    optional_integer_fields = (
        ...
        "glm53_coalesced_expert_layers",
        "glm53_coalesced_expert_input_positions",
        "glm53_coalesced_expert_route_assignments",
        "glm53_coalesced_expert_unique_experts",
        "glm53_coalesced_expert_max_unique_experts",
        ...
        "glm53_layer_stationary_transient_reservation_calls",
        "glm53_layer_stationary_transient_reservation_bytes",
        "glm53_layer_stationary_transient_reservation_margin_bytes",
        "glm53_layer_stationary_transient_reservation_first_margin_calls",
        "glm53_layer_stationary_transient_reservation_recurring_calls",
        ...
        "qwen35_serial_kv_reclaim_topup_enabled",
        "qwen35_phase_head_pre_admit_enabled",
        ...
        "qwen4_retained_conv_compact_prefix_tokens",
        "qwen4_retained_conv_compact_active_before_bytes",
        "qwen4_retained_conv_compact_active_after_bytes",
        "qwen4_retained_projected_logical_bytes",
        "qwen4_retained_qsa_backing_allowance_bytes",
        ...
        "qwen4_serial_verify_exact_bf16_fallback_unavailable_calls",
        "qwen4_serial_verify_exact_bf16_fallback_rank_calls",
        "qwen4_serial_verify_exact_bf16_fallback_dtype_calls",
        "qwen4_serial_verify_exact_bf16_fallback_inner_dimension_calls",
        "qwen4_serial_verify_exact_bf16_fallback_empty_batch_calls",
        "qwen4_serial_verify_exact_bf16_fallback_singleton_window_calls",
        "qwen4_serial_verify_exact_bf16_fallback_window_too_wide_calls",
        "qwen4_serial_verify_exact_bf16_fallback_output_geometry_calls",
        "qwen4_serial_verify_exact_bf16_fallback_skinny_output_calls",
        "qwen4_serial_verify_exact_bf16_fallback_unknown_calls",
    ...
    for key in (
        ...
        "qwen_mtp_greedy_draft_margin_thresholds",
        "qwen_mtp_greedy_margin_rank_counts_by_step",
        "qwen_mtp_greedy_round_confidence_records",
